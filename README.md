...
- **소셜 로그인**:
  ...
  - Google과 Apple 로그인 가능.

- **동아리 일정관리**:
  - 캘린더 UI를 통해 동아리 관련 일정 추가&삭제가 가능합니다.

- **알림 전송**:
  - FCM을 통해 알림을 발송할 수 있습니다.
  - 공지사항 및 댓글이 달렸을 경우 알림이 발송됩니다.

- **글 검색**:
  - 키워드를 통해 특정 글 검색이 가능합니다.

- **사진 업로드**:
  - 최대 10장의 사진을 게시글과 함께 업로드 할 수 있습니다.

- **동아리 SNS 이동**:
  - 동아리의 인스타 및 네이버 카페로 이동이 가능합니다.

- **익명 프로필**:
  - 모든 사용자는 철저하게 익명으로 활동하며 원하는 닉네임과 사진으로 언제든 변경할 수 있습니다.

- **내가 작성한 글 및 댓글 찾기**:
  - 내가 작성한 글과 댓글을 찾을 수 있습니다.
...
|로그인 성공 시 보여지는 메인화면 입니다|


|자유게시판|
|:---:|
|<img src="https://github.com/user-attachments/assets/a8aab72a-b963-4bb5-b4bc-42ff881f2705" width="450"/>|
|동아리원들이 자유롭게 글을 작성할 수 있는 게시판 중 하나인 자유게시판의 모습입니다|


|글 작성 UI|
|:---:|
|<img src="https://github.com/user-attachments/assets/7bf03b70-0f7c-4ccc-8551-98bc8477ba18" width="450"/>|
|글 버튼 클릭 시 나타나는 UI 입니다|


|프로필|
|:---:|
|<img src="https://github.com/user-attachments/assets/9b7427c7-e73f-436a-aa4a-ee29145e067e" width="450"/>|
|본인의 프로필을 확인 및 수정할 수 있는 페이지 입니다|


|캘린더|
|:---:|
|<img src="https://github.com/user-attachments/assets/f652e1c5-90c0-4e2d-b1d2-f4007b5e8c90" width="450"/>|
|누구나 자유롭게 일정을 추가할 수 있는 캘린더 페이지입니다|
