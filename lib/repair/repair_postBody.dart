...
class RepairFeedPageBodyState extends State<RepairFeedPageBody>
    with AutomaticKeepAliveClientMixin<RepairFeedPageBody> {
  int currentPage = 0;
  late FeedPost post;
  String avatarUrl =
  ...
  Future<void> deleteRepair(String documentId) async {
    DocumentSnapshot snapshot = await FirebaseFirestore.instance
        .collection('Repair')
  ...
  Future<void> handleLikeButtonPressed(
    ...
    DocumentReference postRef =
        FirebaseFirestore.instance.collection('Repair').doc(widget.documentId);
          ...
          return Column(
            ...
            children: [
              InkWell(
                onTap: () {
                  GoRouter.of(context)
                      .push('/Repair_postDetailPage', extra: post);
                },
                child: Container(
