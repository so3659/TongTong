...
import 'package:tongtong/repair/repair_postDetailPageBody.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'dart:math';
import 'package:tongtong/repair/repair_comment_list_body.dart';
import 'package:tongtong/repair/repair_reply_list_body.dart';
import 'package:http/http.dart' as http;

class RepairDetailPage extends ConsumerStatefulWidget {
  final FeedPost post;
  const RepairDetailPage({super.key, required this.post});

  @override
  RepairDetailPageState createState() => RepairDetailPageState();
}

class RepairDetailPageState extends ConsumerState<RepairDetailPage> {
  final String _chars =
  ...
  Future<void> addComment(String postId, String content) async {
    ...
    DocumentReference postRef =
        FirebaseFirestore.instance.collection('Repair').doc(postId);
  ...
  Future<void> addReplyToComment(
    ...
    DocumentSnapshot postSnapshot =
        await FirebaseFirestore.instance.collection("Repair").doc(postId).get();
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, child) {
      final focusManager = ref.watch(repair_focusManagerProvider);
      final currentReplyingCommentId = ref.watch(repair_replyProvider);
      ...
      if (focusManager.shouldFocusCommentField) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          ref.read(repair_focusManagerProvider).resetFocusRequest();
        });
      }
      return Scaffold(
