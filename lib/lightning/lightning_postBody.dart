...
class LightningFeedPageBody extends StatefulWidget {
  ...
  @override
  LightningFeedPageBodyState createState() => LightningFeedPageBodyState();
}

class LightningFeedPageBodyState extends State<LightningFeedPageBody>
    with AutomaticKeepAliveClientMixin<LightningFeedPageBody> {
  int currentPage = 0;
  late FeedPost post;
  String avatarUrl =
          ...
          return Column(
            ...
            children: [
              InkWell(
                onTap: () {
                  GoRouter.of(context)
                      .push('/Lightning_postDetailPage', extra: post);
                },
                child: Container(
