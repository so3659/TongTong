...
class MakeLightning extends StatefulWidget {
  const MakeLightning({super.key});

  @override
  State<MakeLightning> createState() => MakeLightningState();
}

class MakeLightningState extends State<MakeLightning> {
  ...
  Future<List<Map<String, String>>> _imagePickerToUpload(
    ...
    for (XFile image in nonNullableImages) {
      ...
      String imageRef = "lightning/$_uid/$dateTime";
            ...
            children: [
              TextField(
                decoration: const InputDecoration(
                    hintText: '최고의 번개 장소 및 경험을 공유해주세요!',
