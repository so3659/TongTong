...
import 'package:tongtong/lightning/lightning_postDetailPageBody.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'dart:math';
import 'package:tongtong/lightning/lightning_comment_list_body.dart';
import 'package:tongtong/lightning/lightning_reply_list_body.dart';
import 'package:http/http.dart' as http;

class LightningDetailPage extends ConsumerStatefulWidget {
  final FeedPost post;
  const LightningDetailPage({super.key, required this.post});

  @override
  LightningDetailPageState createState() => LightningDetailPageState();
}

class LightningDetailPageState extends ConsumerState<LightningDetailPage> {
  final String _chars =
  ...
  Future<void> addComment(String postId, String content) async {
    ...
    DocumentReference postRef =
        FirebaseFirestore.instance.collection('Lightning').doc(postId);
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, child) {
      final focusManager = ref.watch(lightning_focusManagerProvider);
      final currentReplyingCommentId = ref.watch(lightning_replyProvider);
      ...
      if (focusManager.shouldFocusCommentField) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          ref.read(lightning_focusManagerProvider).resetFocusRequest();
        });
      }
      return Scaffold(
