...
import 'package:tongtong/knowhow/knowhow_postDetailPageBody.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'dart:math';
import 'package:tongtong/knowhow/knowhow_comment_list_body.dart';
import 'package:tongtong/knowhow/knowhow_reply_list_body.dart';
import 'package:http/http.dart' as http;

class KnowhowDetailPage extends ConsumerStatefulWidget {
  final FeedPost post;
  const KnowhowDetailPage({super.key, required this.post});

  @override
  KnowhowDetailPageState createState() => KnowhowDetailPageState();
}

class KnowhowDetailPageState extends ConsumerState<KnowhowDetailPage> {
  final String _chars =
  ...
  Future<void> addComment(String postId, String content) async {
    ...
    DocumentReference postRef =
        FirebaseFirestore.instance.collection('Knowhow').doc(postId);
    ...
    return Consumer(builder: (context, ref, child) {
      ...
      if (focusManager.shouldFocusCommentField) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          ref.read(knowhow_focusManagerProvider).resetFocusRequest();
        });
      }
      return Scaffold(
