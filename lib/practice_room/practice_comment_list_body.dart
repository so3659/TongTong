...
final practice_focusManagerProvider =
    ChangeNotifierProvider((ref) => FocusManager());
final practice_replyProvider =
          ...
          actions: [
            ElevatedButton(
              onPressed: () {
                if (!mounted) return;
                ref
                    .read(practice_focusManagerProvider)
                    .requestFocusToCommentField();
                // ReplyNotifier에 commentId 전달
                ref
                    .read(practice_replyProvider.notifier)
