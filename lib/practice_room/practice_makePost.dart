...
class MakePractice extends StatefulWidget {
  const MakePractice({super.key});

  @override
  State<MakePractice> createState() => MakePracticeState();
}

class MakePracticeState extends State<MakePractice> {
  ...
  Future<List<Map<String, String>>> _imagePickerToUpload(
    ...
    for (XFile image in nonNullableImages) {
      ...
      String imageRef = "practice/$_uid/$dateTime";
  ...
  Future<void> _toFirestore(List<Map<String, String>>? images, String postKey,
    ...
    try {
      DocumentReference<Map<String, dynamic>> reference =
          FirebaseFirestore.instance.collection("Practices").doc(postKey);
