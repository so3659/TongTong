...
class UpdatePractice extends StatefulWidget {
  const UpdatePractice({super.key, required this.documentId});

  final String documentId;

  @override
  State<UpdatePractice> createState() => UpdatePracticeState();
}

class UpdatePracticeState extends State<UpdatePractice> {
