...
class PracticeFeedPageBody extends StatefulWidget {
  ...
  @override
  PracticeFeedPageBodyState createState() => PracticeFeedPageBodyState();
}

class PracticeFeedPageBodyState extends State<PracticeFeedPageBody>
    with AutomaticKeepAliveClientMixin<PracticeFeedPageBody> {
  int currentPage = 0;
  late FeedPost post;
  String avatarUrl =
  ...
  Future<void> deletePractice(String documentId) async {
    DocumentSnapshot snapshot = await FirebaseFirestore.instance
