...
class UpdateRestaurant extends StatefulWidget {
  const UpdateRestaurant({super.key, required this.documentId});

  final String documentId;

  @override
  State<UpdateRestaurant> createState() => UpdateRestaurantState();
}

class UpdateRestaurantState extends State<UpdateRestaurant> {
