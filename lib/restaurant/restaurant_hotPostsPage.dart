...
class HotRestaurantPage extends ConsumerStatefulWidget {
  const HotRestaurantPage({super.key});

  @override
  HotRestaurantPageState createState() => HotRestaurantPageState();
}

class HotRestaurantPageState extends ConsumerState<HotRestaurantPage> {
