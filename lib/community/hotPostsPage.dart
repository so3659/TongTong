...
class HotPostPage extends ConsumerStatefulWidget {
  const HotPostPage({super.key});

  @override
  HotPostPageState createState() => HotPostPageState();
}

class HotPostPageState extends ConsumerState<HotPostPage> {
